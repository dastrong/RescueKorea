        ...
        get: {
          ...
          field: function(identifier) {
            ...
            if ($field.filter("#" + identifier).length > 0) {
              ...
              $field.filter("[data-" + metadata.validate + '="' + identifier + '"]')
                .length > 0
            ) {
              return $field.filter(
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        is: {
          ...
          indeterminate: function() {
            return (
              $input.prop("indeterminate") !== undefined && $input.prop("indeterminate")
            );
          },
          checked: function() {
      ...
      module = {
        ...
        has: {
          dimmer: function() {
            if (settings.dimmerName) {
              return (
                $module.find(selector.dimmer).filter("." + settings.dimmerName).length > 0
              );
            } else {
      ...
      module = {
          ...
          selectValues: function() {
            ...
            $module.find("option").each(function() {
              var $option = $(this),
                ...
                value =
                  $option.attr("value") !== undefined ? $option.attr("value") : name;
        ...
        is: {
          ...
          bubbledLabelClick: function(event) {
            return (
              $(event.target).is("select, input") && $module.closest("label").length > 0
            );
          },
        ...
        can: {
          ...
          openDownward: function($subMenu) {
            ...
            calculations = {
              context: {
                offset:
                  $context.get(0) === window ? { top: 0, left: 0 } : $context.offset(),
        ...
        cacheSizes: function() {
          ...
          if (module.cache === undefined || modalHeight !== 0) {
            module.cache = {
              ...
              contextHeight:
                settings.context == "body" ? $(window).height() : $dimmable.height(),
            };
      ...
      module = {
        ...
        get: {
          ...
          content: function() {
            ...
            return (
              $module.data(metadata.content) || settings.content || $module.attr("title")
            );
          },
          variation: function() {
          ...
          calculations: function() {
            ...
            calculations.target.margin.top = settings.inline
              ? parseInt(
                  window.getComputedStyle(targetElement).getPropertyValue("margin-top"),
                  10
                )
              : 0;
        ...
        event: {
          ...
          click: function() {
            var $activeIcon = $(this),
              ...
              canClear =
                settings.clearable == "auto" ? $icon.length === 1 : settings.clearable;
        ...
        event: {
          ...
          blur: function(event) {
            ...
            if (module.resultsClicked) {
              ...
              $module.one("click.close" + eventNamespace, selector.results, function(
                event
              ) {
          ...
          result: {
            ...
            click: function(event) {
              ...
              var $result = $(this),
                ...
                result =
                  $result.data(metadata.result) || module.get.result(value, results),
                returnedValue;
      ...
      module = {
        ...
        event: {
          clickaway: function(event) {
            var clickedInPusher =
                $pusher.find(event.target).length > 0 || $pusher.is(event.target),
        ...
        is: {
          ...
          visible: function() {
            if (module.cache && module.cache.element) {
              return !(
                module.cache.element.width === 0 && module.cache.element.offset.top === 0
              );
            }
            return false;
          },
