          ...
          (h = {
            ...
            bindEvents: function() {
              h.verbose("Attaching form events"),
                ...
                d.keyboardShortcuts &&
                  o.on("keydown" + m, f.field, h.event.field.keydown),
                n.each(function() {
                  var e = T(this),
                    t = e.prop("type"),
              ...
              n.each(function() {
                ...
                i !== O &&
                  (l &&
                    ...
                    r.remove()),
                  o
                    ? (h.verbose("Resetting dropdown value", t, i),
                ...
                keydown: function(e) {
                  ...
                  n == 27 && (h.verbose("Escape key pressed blurring field"), t.blur()),
                    e.ctrlKey ||
                      ...
                      i ||
                      (y ||
                        (t.one("keyup" + m, h.event.field.keyup),
                        h.submit(),
            ...
            get: {
              ...
              prompt: function(e, t) {
                ...
                return (
                  ...
                  e.prompt || h.verbose("Using default validation prompt for type", s, i),
                  s
                );
              },
              settings: function() {
              ...
              validation: function(n) {
                ...
                return (
                  ...
                  (T.each(u, function(e, t) {
                    (i = t.identifier || e),
                      h.get.field(i)[0] == n[0] && ((t.identifier = i), (r = t));
                  }),
                  r || !1)
                );
              },
            ...
            has: {
              field: function(e) {
                return (
                  ...
                  "string" != typeof (e = h.escape.string(e)) && h.error(l.identifier, e),
                  0 < n.filter("#" + e).length ||
                    (0 < n.filter('[name="' + e + '"]').length ||
                      0 < n.filter("[data-" + c.validate + '="' + e + '"]').length)
                );
                  ...
                  T.each(e, function(e, t) {
                    ...
                    0 < r.length &&
                      (a && o
                        ...
                        : l
                        ? (h.verbose("Setting dropdown value", t, i),
            ...
            validate: {
              ...
              field: function(n, e, t) {
                (t = t === O || t),
                  "string" == typeof n &&
                    (h.verbose("Validating field", n), (n = u[(e = n)]));
                ...
                return (
                  n.identifier ||
                    (h.debug("Using field name as identifier", r), (n.identifier = r)),
                  i.prop("disabled")
                    ? (h.debug("Field is disabled. Skipping", r), (o = !0))
                    : n.optional && h.is.blank(i)
                    ? (h.debug("Field is optional and blank. Skipping", r), (o = !0))
                    ...
                    : n.rules !== O &&
                      T.each(n.rules, function(e, t) {
                        h.has.field(r) &&
                          !h.validate.rule(n, t) &&
                          (h.debug("Field is invalid", r, t.type),
                          l.push(h.get.prompt(t, n)),
                          (o = !1));
                      }),
                  o
                    ? (t && (h.remove.prompt(r, l), d.onValid.call(i)), !0)
                    : (t &&
                        ((b = b.concat(l)), h.add.prompt(r, l), d.onInvalid.call(i, l)),
                      !1)
                );
              },
              rule: function(e, t) {
              ...
              return (
                ...
                "string" == typeof r &&
                  ...
                  T.each(r, function(e, t) {
                    var n =
                      e != i
                        ? t + r[e + 1].charAt(0).toUpperCase() + r[e + 1].slice(1)
                        : r;
