          ...
          (m = {
                    ...
                    if (t == p.downArrow) {
                      if (
                        ...
                        (n =
                          d && c
                            ? (n = o
                                .nextAll(w.item + ":not(" + w.unselectable + ")")
                                .eq(0))
                            : R.eq(0)).length
                      )
                        return (
            ...
            determine: {
              ...
              eventOnElement: function(e, t) {
                ...
                return (
                  ...
                  a && o && s
                    ? (m.verbose("Triggering event", t), t(), !0)
                    : (m.verbose("Event occurred in dropdown menu, canceling callback"),
                      !1)
                );
              },
            },
            action: {
              ...
              activate: function(e, t, n) {
                if (((t = t !== J ? t : e), m.can.activate(X(n)))) {
                  if ((m.set.selected(t, X(n)), m.is.multiple() && !m.is.allFiltered()))
                    return;
                  m.hideAndClear();
                }
              },
              select: function(e, t, n) {
                if (((t = t !== J ? t : e), m.can.activate(X(n)))) {
                  if ((m.set.value(t, e, X(n)), m.is.multiple() && !m.is.allFiltered()))
                    return;
                  m.hideAndClear();
                }
              },
            ...
            get: {
              ...
              item: function(i, a) {
                ...
                return (
                  (i =
                    i !== J ? i : m.get.values() !== J ? m.get.values() : m.get.text()),
                    ...
                    R.each(function() {
                      ...
                      if (null !== n && n !== J)
                        if (o)
                          ...
                          return (
                            m.verbose("Found select item by value", n, i), (s = e), !0
                          );
                    }),
                  s
                );
                ...
                return (
                  ...
                  ((e = e !== J ? e : m.get.selectionCount()) >= h.maxSelections
                    ? (m.debug("Maximum selection count reached"),
                      h.useLabels &&
                        (R.addClass(g.filtered), m.add.message(c.maxSelections)),
                      !0)
            ...
            has: {
              ...
              label: function(e) {
                ...
                return (
                  ...
                  0 <
                    n.filter("[data-" + b.value + '="' + m.escape.string(t) + '"]').length
                );
              },
