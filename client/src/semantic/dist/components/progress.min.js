      ...
      e.each(function() {
        ...
        (s = {
          ...
          set: {
            ...
            percent: function(e) {
              (e = "string" == typeof e ? +e.replace("%", "") : e),
                ...
                s.has.total() ||
                  ((s.value =
                    0 < r.precision
                      ? Math.round((e / 100) * s.total * (10 * r.precision)) /
                        (10 * r.precision)
            ...
            label: function(e) {
              (e = e || "") &&
                ((e = s.get.text(e)), s.verbose("Setting label to text", e), g.text(e));
            },
            state: function(e) {
          ...
          setting: function(e, t) {
            if ((s.debug("Changing setting", e, t), E.isPlainObject(e)))
              E.extend(!0, r, e);
            else {
              if (t === T) return r[e];
            ...
            return (
              ...
              "string" == typeof r &&
                ...
                E.each(r, function(e, t) {
                  var n =
                    e != a ? t + r[e + 1].charAt(0).toUpperCase() + r[e + 1].slice(1) : r;
