          ...
          (m = {
            ...
            set: {
              ...
              duration: function(n, e) {
                ((e = "number" == typeof (e = e || d.duration) ? e + "ms" : e) ||
                  0 === e) &&
            ...
            save: {
              ...
              transitionExists: function(n, e) {
                (C.fn.transition.exists[n] = e),
                  m.verbose("Saving existence of transition", n, e);
              },
            },
            restore: {
              conditions: function() {
            ...
            get: {
              ...
              displayType: function(n) {
                return (
                  ...
                  d.displayType
                    ? d.displayType
                    : (n && f.data(i.displayType) === S && m.can.transition(!0),
            ...
            setting: function(n, e) {
              if ((m.debug("Changing setting", n, e), C.isPlainObject(n)))
                C.extend(!0, d, n);
              else {
                if (e === S) return d[n];
              ...
              return (
                ...
                "string" == typeof t &&
                  ...
                  C.each(t, function(n, e) {
                    var i =
                      n != a
                        ? e + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1)
                        : t;
