          ...
          (c = {
            ...
            attachEvents: function(e, n) {
              ...
              (n = j.isFunction(c[n]) ? c[n] : c.toggle),
                0 < i.length
                  ? (c.debug("Attaching modal events to element", e, n),
              ...
              events: function() {
                c.verbose("Attaching events"),
                  v
                    ...
                    .on("click" + g, d.approve, c.event.approve)
                ...
                c.is.animating() || !c.is.active()
                  ? (c.showDimmer(),
                    ...
                    !l.allowMultiple && c.others.active()
                      ...
                      : (l.allowMultiple && l.detachable && v.detach().appendTo(a),
                        l.onShow.call(y),
                        l.transition &&
                        j.fn.transition !== N &&
            ...
            hideModal: function(e, n) {
              (e = j.isFunction(e) ? e : function() {}),
                ...
                !1 !== l.onHide.call(y, j(this))
                  ? (c.is.animating() || c.is.active()) &&
                    (l.transition && j.fn.transition !== N && v.transition("is supported")
                      ? (c.remove.active(),
                        v.transition({
                          debug: l.debug,
                          ...
                          useFailSafe: !0,
                          onStart: function() {
                            c.others.active() || n || c.hideDimmer(),
            ...
            hideOthers: function(e) {
              ...
              (e = j.isFunction(e) ? e : function() {}),
                0 < n.length &&
                  (c.debug("Hiding other modals", t), n.modal("hide modal", e, !0));
            },
            others: {
              active: function() {
            ...
            remove: {
              ...
              bodyStyle: function() {
                "" === x.attr("style") &&
                  (c.verbose("Removing style attribute"), x.removeAttr("style"));
              },
            ...
            set: {
              ...
              dimmerSettings: function() {
                if (j.fn.dimmer !== N) {
                  ...
                  l.inverted &&
                    (n.variation =
                      n.variation !== N ? n.variation + " inverted" : "inverted"),
                    b.dimmer("setting", n);
              ...
              screenHeight: function() {
                c.can.fit()
                  ...
                  : (c.debug("Modal is taller than page content, resizing page height"),
                    x.css("height", c.cache.height + 2 * l.padding));
              },
              active: function() {
                v.addClass(u.active);
              },
            ...
            setting: function(e, n) {
              if ((c.debug("Changing setting", e, n), j.isPlainObject(e)))
                j.extend(!0, l, e);
              else {
                if (n === N) return l[e];
              ...
              return (
                ...
                "string" == typeof t &&
                  ...
                  j.each(t, function(e, n) {
                    var i =
                      e != o
                        ? n + t[e + 1].charAt(0).toUpperCase() + t[e + 1].slice(1)
                        : t;
