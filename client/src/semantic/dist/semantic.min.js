            ...
            (g = {
              ...
              refreshSelectors: function() {
                g.verbose("Refreshing selector cache"),
                  ...
                  (P = w.find(y.icon)),
                  (E =
                    0 < w.prev().find(y.text).length ? w.prev().find(y.text) : w.prev()),
                  (F = w.children(y.menu)),
                  (O = F.find(y.item));
              },
              ...
              get: {
                ...
                item: function(i, o) {
                  ...
                  return (
                    (i =
                      i !== J ? i : g.get.values() !== J ? g.get.values() : g.get.text()),
                  ...
                  return (
                    ...
                    ((e = e !== J ? e : g.get.selectionCount()) >= p.maxSelections
                      ? (g.debug("Maximum selection count reached"),
                        p.useLabels &&
                          (O.addClass(h.filtered), g.add.message(c.maxSelections)),
                        !0)
            ...
            (s = {
              ...
              determine: {
                ...
                url: function() {
                  ...
                  return (
                    (e = o[n] !== A && o[n].url.replace("{id}", t)) && d.data(a.url, e), e
                  );
                },
              },
              set: {
          ...
          e.each(function() {
            ...
            (l = {
              ...
              is: {
                ...
                ie: function() {
                  return (
                    (!z.ActiveXObject && "ActiveXObject" in z) || "ActiveXObject" in z
                  );
                },
                animating: function() {
            ...
            get: {
              ...
              normalizedValue: function(e) {
                ...
                if (s.has.total()) {
                  if (e > s.total)
                    return (
                      s.debug("Value cannot increment above total", s.total), s.total
                    );
                } else if (100 < e)
              ...
              percent: function(e) {
                (e = "string" == typeof e ? +e.replace("%", "") : e),
                  ...
                  s.has.total() ||
                    ...
                    i.limitValues &&
                      (s.value = 100 < s.value ? 100 : s.value < 0 ? 0 : s.value)),
                  s.set.barWidth(e),
                  s.set.labelInterval(),
                  s.set.labels(),
          ...
          E(this).each(function() {
            ...
            (f = {
              ...
              can: {
                ...
                transition: function() {
                  return (
                    c.transition && E.fn.transition !== D && h.transition("is supported")
                  );
                },
              },
              is: {
          ...
          e.each(function() {
            ...
            (c = {
              ...
              is: {
                ie: function() {
                  return (
                    (!j.ActiveXObject && "ActiveXObject" in j) || "ActiveXObject" in j
                  );
                },
                ios: function() {
          ...
          (l = {
            ...
            get: {
              ...
              urlEncodedValue: function(e) {
                ...
                return t !== e
                  ? (l.debug("URL value is already encoded, avoiding double encoding", e),
                    e)
