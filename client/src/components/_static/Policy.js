      ...
      <Accordion styled className="lp-accordion">
        ...
        <Accordion.Content active={activeIndex === 0}>
          <List as="ul" className="listing-policy-items">
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">ONE animal per listing.</span> If you have
              multiple animals make separate listings and add a link to your other listing
              in the description.
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
              ...
              animal’s name in Hangeul. Also, to avoid errors in your upload, please keep
              the name short (example: "David", not "David formerly Socks").
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">Min 1 photo; Max 3 photos.</span> Please
              try to crop your photos into a sqaure or landscape view (long) for the best
              possible experience.
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">
              ...
              Only list animals that you have in your possession. Please do NOT post about
              animals you’ve seen on the street if you did not take the animal in. Please
              also do not post for animals in a government pound. We know you want to help
              these animals, but the best way would be to take them in as a foster family
              or take them to a local no-kill shelter. If you are posting on behalf of a
              no-kill shelter, you must provide written authorization from the shelter
              owner that you are the designated contact for posting listings.
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">
              ...
              listing will be removed from the site and the user will be issued a warning.
              Several incidences will result in the user being blacklisted.
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">DELETE your listing after adoption.</span>{" "}
        ...
        <Accordion.Content active={activeIndex === 1}>
          <List as="ol" className="listing-policy-items">
            ...
            <List.Item as="li" className="listing-policy-item">
              Fill in all required information, including at least one photo. Remember to
              follow the posting guidelines above.
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
        ...
        <Accordion.Content active={activeIndex === 2}>
          <List as="ul" className="listing-policy-items">
            <List.Item as="li" className="listing-policy-item">
              <span className="policy-heading">How to edit/delete your listing?</span> Log
              into your account and go to your listing. Scroll to the bottom and click the
              edit or delete button. *Listings are automatically deleted after 90 days of
              creation*
            </List.Item>
            <List.Item as="li" className="listing-policy-item">
